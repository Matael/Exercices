...
\begin{align}
	<W>&=\dfrac{1}{T} \ds{\int_0^{T}} \re{\hat{p}e^{j\omega t}}\re{\hat{v}e^{j\omega t}} \d t\\
	   ...
	   \dfrac{\hat{p}e^{j\omega t}+\hat{p}\cj e^{-j\omega t} }{2}
	   \dfrac{\hat{v}e^{j\omega t}+\hat{v}\cj e^{-j\omega t} }{2}
	   \right] \d t\\
	    &=\dfrac{1}{4T} \ds{\int_0^{T}} \left[
	    \hat{p}\hat{v}e^{2j\omega t}+\hat{p}\hat{v}\cj+\hat{p}\cj\hat{v}+\hat{v}\cj\hat{p}\cj e^{-2j\omega t}
	   \right] \d t\\
\end{align}
...
\begin{align}
	<W>&=
	    \dfrac{1}{4T} \ds{\int_0^{T}} \left[
	   \hat{p}\hat{v}\cj+\hat{p}\cj\hat{v}  \right] \d t =\dfrac{1}{4T}  \left[
	   \hat{p}\hat{v}\cj+\hat{p}\cj\hat{v}  \right] T\\
	   &=\dfrac{1}{2}\re{\hat{p}\hat{v}\cj}.
\end{align}
